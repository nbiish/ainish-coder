...
def main():
    ...
    for i, chapter in enumerate(chapters):
        ...
        prompt = (
            f"You are an Omni Model Analyst. Analyze this section of the video titled '{c_title}'. "
            ...
            "core objectives of the target document if applicable. Create a comprehensive markdown "
