...
2. **`sanitize-settings.sh`** - Manual cleaning script
...
3. **Clean existing files**: `./sanitize-settings.sh`
...
./setup-secret-protection.sh  # Choose option 1
...
**⚠️ IMPORTANT:** Before pushing to GitHub, run `./sanitize-settings.sh` to clean these!
