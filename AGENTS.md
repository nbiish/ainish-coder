...
When a coding task requires heavy autonomous implementation, multi-file refactoring, or iterative test repair, the orchestrator delegates to headless terminal coding agents (`trae-mini-fleet`):
