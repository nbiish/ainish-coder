...
6. **Mastery:** read `.agents/skills/repo-memory/SKILL.md` — harness-agnostic memory-discipline loop, routing doctrine, session protocols, MCP wiring for any harness, smoke tests, hygiene.
</REPO_MEMORY>
