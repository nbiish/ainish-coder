...
7. **Mastery:** read `.agents/skills/repo-memory-graph-intelligence/SKILL.md` — harness-agnostic memory-discipline loop, routing doctrine, session protocols, MCP wiring for any harness, `.agents/memories/` write protocol, smoke tests, hygiene.
</REPO_MEMORY>
